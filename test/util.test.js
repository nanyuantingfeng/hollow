...
test('fnBuildHTML:production', () => {
  let context = {
    ...
    sdks: {
      a: ['es6-promise.auto.min.js', 'fetch.js'],

      b: ['es6-promise.auto.min.js', 'fetch.js', 'https://a.b.c.d/e.js'],

      c: ['es6-promise.auto.min.js', 'fetch.js', 'https://a.b.c.d/e.js'],

      d: ['es6-promise.auto.min.js', 'fetch.js', 'https://a.b.c.d/e.js']
    },
