...
exports.default = function () {
  var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(context, next) {
    var cwd, hash, outputPath, devtool, limit, default_node_env, packageMap, env, jsFileName, cssFileName, commonName, theme, node, babelOptions, postcssOptions, tsOptions, rules;
    return _regenerator2.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            cwd = context.cwd, hash = context.hash, outputPath = context.outputPath, devtool = context.devtool, limit = context.limit, default_node_env = context.default_node_env, packageMap = context.packageMap;
