...
exports.default = function () {
  var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(context, next) {
    var devServer, webpackConfig, _webpackConfig$plugin, plugins, _devServer, host, port, port0, port1, uri;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            webpackConfig.devServer = devServer = (0, _extends3.default)({
              hot: true,
              hotOnly: true,
              contentBase: false,
              inline: true,
            ...
            _devServer = devServer, host = _devServer.host, port = _devServer.port;
